...
<head>
    ...
    <title>Depósito Monetario</title>
...
<header>
    ...
    <div class="nav-bar">
        <nav id="main" class="container">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-moneybag" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="container">
        <section>
            <div class="seccion">
            <div class="bloque">
                <h3>Depósito Monetario</h3>
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-home-dollar" width="36" height="36" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                <p>
                    Hola, <?php echo $_SESSION['nameUser'] ?>! Aquí puedes Ingresar la información correspondiente para realizar depósitos a cuentas monetarias. Por favor, completa los siguientes campos.
                </p>
                <form action="procesaDeposito.php" method="POST" id="miFormulario5">
                    <label class="form-label" for="cuenta_deposito">*Cuenta a la cuál se le hará el depósito: </label>
                    <select class="form-option" name="cuenta_deposito" id="cuenta_deposito" required  onchange="actualizarInfoCuenta()">
                    ...
                    <label class="form-label" for="cantidad_deposito">Cantidad a Depositar</label>
                    <input class="form-input" type="numb" name="cantidad_deposito" id="cantidad_deposito">
                    
                    <input type="hidden" name="formulario_enviado" value="1">
                    <button class="form-button" type="submit" onclick="validar5(event)">Realizar Deposito</button>
                </form>
            </div>
        </section>
    </div>
    ...
    <script>
        function actualizarInfoCuenta() { 
            var selectedCuenta = document.getElementById("cuenta_deposito").value;
